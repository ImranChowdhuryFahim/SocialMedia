            ...
            <div data-tooltip="bla bla" >
                <div className={this.props.cls === 'sent' ? "msgrowsent" : "msgrowrecieved"} >
                    ...
                    <div  className={(this.state.active===true?'active ':' ') + (this.props.cls === 'sent' ? "invisibledivsent": "invisibledivrecieved")}  >
                        <span>
                            <button onMouseDown={this.active.bind(this)} onBlur={this.deactive.bind(this)} className="svgbutton tooltip" data-tooltip="React">
                        ...
                        <span>
                            <button onMouseDown={this.active.bind(this)} onBlur={this.deactive.bind(this)}  className="svgbutton tooltip" data-tooltip="Reply" >
                        ...
                        <span>
                            <button onMouseDown={this.active.bind(this)} onBlur={this.deactive.bind(this)}  className="svgbutton tooltip" data-tooltip="More">
